      ...
      <Modal setOpen={setIsOpen} open={isOpen} title="Quick Preview">
        ...
        <div className="mt-6 flex justify-center">
          <Link
            ...
            href={`/product/${productId}` as Route}
          >
