...
- Every data fetch is server components. In modern Next.js, dynamic vs static is a scale, and we decide how much static we want. We can have one paradigm and one mental model, performant and composable by default.
